...
from bayes_design.utils import load_config_and_merge, parse_design_regions_arg
...
compare_seq_probs_parser.add_argument('--config', help="Path to a JSON config file. Values override CLI arguments.", default=None)
...
compare_seq_probs_parser.add_argument('--protein_id', help="The PDB id of the structure for the protein sequences (provide this or --pdb_path)", default=None)
compare_seq_probs_parser.add_argument('--pdb_path', help="Path to a local PDB file (provide this or --protein_id)", default=None)
...
compare_struct_correlation_parser.add_argument('--config', help="Path to a JSON config file. Values override CLI arguments.", default=None)
compare_struct_correlation_parser.add_argument('--protein_id', help="The PDB id of the structure for the protein sequences (provide this or --pdb_path)", default=None)
compare_struct_correlation_parser.add_argument('--pdb_path', help="Path to a local PDB file (provide this or --protein_id)", default=None)
...
compare_struct_correlation_parser.add_argument('--design_regions', help='JSON string defining named design regions', type=str, default='{}')
...
viz_probs_parser.add_argument('--config', help="Path to a JSON config file. Values override CLI arguments.", default=None)
viz_probs_parser.add_argument('--sequence', help='String representations of the protein sequence to redesign', required=True)
viz_probs_parser.add_argument('--protein_id', help="The PDB id of the structure for the protein sequences (provide this or --pdb_path)", default=None)
viz_probs_parser.add_argument('--pdb_path', help="Path to a local PDB file (provide this or --protein_id)", default=None)
...
viz_probs_parser.add_argument('--design_regions', help='JSON string defining named design regions', type=str, default='{}')
...
hist_parser.add_argument('--config', help="Path to a JSON config file. Values override CLI arguments.", default=None)
...
hist_parser.add_argument('--protein_id', help="The PDB id of the structure for the protein sequences (provide this or --pdb_path)", default=None)
hist_parser.add_argument('--pdb_path', help="Path to a local PDB file (provide this or --protein_id)", default=None)
...
seq_filter_parser.add_argument('--config', help="Path to a JSON config file. Values override CLI arguments.", default=None)
...
seq_filter_parser.add_argument('--protein_id', help="The PDB id of the structure for the protein sequences (provide this or --pdb_path)", default=None)
seq_filter_parser.add_argument('--pdb_path', help="Path to a local PDB file (provide this or --protein_id)", default=None)
...
def parse_seq(args):
    ...
    if getattr(args, 'sequences', None) is not None:
        return args
    elif getattr(args, 'sequences_path', None) is not None:
        args.sequences = []
...
if __name__ == '__main__':
    ...
    # Merge JSON config (if provided) and parse design_regions for subcommands that support it
    if hasattr(args, 'func'):
        # Find the subparser that was used so we can detect CLI defaults
        # We pass the main parser; load_config_and_merge handles default comparison
        args = load_config_and_merge(args, parser)
        if hasattr(args, 'design_regions'):
